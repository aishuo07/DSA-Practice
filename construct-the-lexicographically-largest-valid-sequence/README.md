<h2>1718. Construct the Lexicographically Largest Valid Sequence</h2><h3>Medium</h3><hr><div><p>Given an integer <code>n</code>, find a sequence that satisfies all of the following:</p>
